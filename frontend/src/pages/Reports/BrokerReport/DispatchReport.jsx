...
const DispatchReport = () => {
  ...
  const currentDayData =
    data?.[`broker${currentDay}Details`]?.flatMap((item) =>
      item ? [item] : []
    ) || [];
            ...
            <table className="min-w-full mt-10 border border-collapse border-gray-300">
              <thead>
                <tr className="bg-transparent">
                  ...
                  <th className="px-4 py-2 text-black font-semibold border border-gray-300">
                    Category
                  </th>
                  <th className="px-4 py-2 text-black font-semibold border border-gray-300">
                    Weight of Bag
              ...
              <tfoot>
                <tr>
                  <td
                    colSpan="5"
                    className="text-center text-gray-700 px-4 py-2"
                  >
